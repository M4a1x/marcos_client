...
if __name__ == "__main__":
    ...
    rf_amp_max = (
        10  # factor used to normalize RF amplitude, should be max value of system used!
    )
    ps = PSAssembler(
    ...
    wait = input(
        "All gradient channels are set to {:f} A. Press Enter to continue.".format(
            current
        )
    )
